...
public:
	...
	void Hook()
	{
		...
		Interfaces.pSurface->SetFontGlyphSet( Font_Tab, "Tahoma", 18, 700, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW | FONTFLAG_OUTLINE );
		Interfaces.pSurface->SetFontGlyphSet( Font_MenuTitle, "Tahoma", 20, 200, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW | FONTFLAG_OUTLINE );
		Interfaces.pSurface->SetFontGlyphSet( Font_Watermark, "Tahoma", 14, 600, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW );
		Interfaces.pSurface->SetFontGlyphSet( Font_Logo, "Tahoma", 48, 600, 0, 0, FONTFLAG_ANTIALIAS );
		Interfaces.pSurface->SetFontGlyphSet( Font_ESP, "Tahoma", 13, 400, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW );
